...
function CustomCard(props) {
  ...
  const pullCanvas = async () => {
    ...
    const responsex = await fetch("https://morning-sierra-77737.herokuapp.com/api/usercards", {
      method: "POST",
      headers: {
  ...
  const handleCustomBackgroundColor = (e) =>{
   let backgroundColorInput = document.getElementById("cardCustomBackgroundColor");
